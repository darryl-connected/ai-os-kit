...
- Skill frontmatter across `.pi/skills/*/SKILL.md`, `~/.pi/agent/skills/*/SKILL.md`, `.claude/skills/*/SKILL.md`, `.agents/skills/*/SKILL.md` — what capabilities exist
...
- **Dry run on a non-trivial vault** with no prompt. Expected: skill surfaces 2-3 candidates pulled from the user's recent activity, priorities, and top_pain. Generic output ("you should build a brief") = fail.
