...
> **pi users:** this file is auto-copied to your vault root as `AGENTS.md` by `harnesses/pi/install.sh`. Edit it directly there.
>
> **Claude Code users:** ignore this file — Claude Code uses the single merged `CLAUDE.md` at the vault root.
